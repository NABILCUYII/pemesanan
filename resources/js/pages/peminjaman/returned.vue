...
import { Search, User, CheckCircle } from 'lucide-vue-next';
...
<template>
    <Head title="Barang yang Sudah Dikembalikan" />
    <AppLayout>
        <div class="p-4 md:p-6 space-y-6">
            <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-800">Barang yang Sudah Dikembalikan</h1>
                    <p class="text-sm text-gray-500 mt-1">Daftar barang yang sudah dikembalikan</p>
                </div>
            </div>
            ...
            <div v-if="filteredPeminjaman.length === 0" class="text-center py-8">
                <div class="text-gray-500">
                    ...
                    <p>Tidak ada barang yang sudah dikembalikan</p>
                </div>
            </div>
        </div>
    </AppLayout>
