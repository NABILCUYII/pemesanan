<template>
  <Head title="Tambah Video Berita" />
    ...
    <div class="min-h-screen bg-gradient-to-br from-[#F0F8FF] via-[#E6F3FF] to-[#F0FFF0] py-12 px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-8">
        <div class="flex items-center justify-between">
          <div>
            <h1 class="text-3xl font-bold text-[#2F4F4F] mb-2">Tambah Video Berita</h1>
            <p class="text-[#708090]">Tambahkan video berita baru untuk ditampilkan di dashboard</p>
          </div>
          <Link
...
import { Plus, ArrowLeft, Save, Loader2 } from 'lucide-vue-next';
