        ...
        <form @submit.prevent="submit" class="space-y-8 bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div 
                @click="form.role = 'penggunaBARU'"
                :class="[
                  'relative p-4 border-2 rounded-lg cursor-pointer transition-all duration-200',
                  form.role === 'penggunaBARU' 
                    ? 'border-indigo-500 bg-indigo-50' 
                    : 'border-gray-200 hover:border-gray-300'
                ]"
              >
                <div class="flex items-center space-x-3">
                  ...
                  />
                  <div>
                    <label for="penggunaBARU" class="font-medium text-gray-900 cursor-pointer">Pengguna BARU</label>
                    <p class="text-sm text-gray-500">Akses khusus pengguna baru</p>
                  </div>
                </div>
              </div>
            </div>
