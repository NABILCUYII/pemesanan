            ...
            <div class="mb-6">
              <div class="relative">
                ...
                <input
                  ...
                  placeholder="Cari barang berdasarkan nama, kode barang, atau lokasi..."
                />
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div class="flex space-x-2">
                        <button
                          ...
                          class="inline-flex items-center px-2 py-1 border border-transparent text-xs font-medium rounded text-blue-700 bg-blue-100 hover:bg-blue-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition ease-in-out duration-150"
                          title="Edit barang"
                        >
