          ...
          <div class="p-6">
            ...
            <div class="mb-6">
              ...
              <p class="text-sm text-gray-500">
                Pilih barang yang hilang dan tentukan jumlahnya
              </p>
            </div>
            ...
            <form @submit.prevent="submitForm" class="space-y-6">
              ...
              <!-- Jumlah Hilang -->
              <div>
                <label for="jumlah_hilang" class="block text-sm font-medium text-gray-700">
                  Jumlah Hilang *
                </label>
                <input
                  id="jumlah_hilang"
                  ...
                  required
                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  placeholder="Masukkan jumlah barang yang hilang"
                />
